---
name: basecamp-start
description: "Start or resume a basecamp memory-bank project in Codex. Use when the user asks to start, orient, summarize project state, load the memory bank, or decide where to pick up."
---
