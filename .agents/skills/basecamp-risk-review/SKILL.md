---
name: basecamp-risk-review
description: "Surface project risks not yet captured in the basecamp memory bank. Use when the user asks for risk review, hidden risks, assumptions, unknowns, or pre-planning risk assessment."
---
