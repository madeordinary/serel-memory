---
name: ship
description: "Run a pre-merge ship readiness checklist. Use when the user asks whether a branch/change is ready to merge, ship, release, or needs final checks."
---
